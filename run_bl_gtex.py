...
subprocess.call(['gsutil','-m','cp','gs://regularized_sldsc/data/annot_and_ldscore/UKBB/GTEx/GTEx.all.*','/mnt/data/annot/'])
...
subprocess.call(['gsutil','-m','cp','/mnt/data/result/*','gs://regularized_sldsc/FI_priors/compare_models/'])
